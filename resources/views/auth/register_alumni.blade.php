...
@section('content')
<div class="main-card w-full max-w-4xl flex lg:absolute lg:top-1/2 lg:-translate-y-1/2 lg:right-10">
    ...
    <div class="w-1/2 p-8 flex flex-col justify-between">
        <div>
            ...
            {{-- START: TEKS INSTRUKSI BARU DITAMBAHKAN DI SINI --}}
