...
<div class="main-card w-full max-w-4xl bg-white rounded-lg shadow-xl overflow-hidden text-gray-800 p-0">
    ...
    <div class="p-6 border-b border-gray-200 bg-gradient-to-r from-blue-50 to-purple-50">
        <div class="flex items-center space-x-3">
            ...
            <div>
                <h1 class="text-2xl font-bold text-gray-800">Submit Konten Anda</h1>
                <p class="text-gray-600">Kirim konten untuk dipublikasikan di komunitas IMU</p>
            </div>
        </div>
    </div>
    ...
    {{-- Form --}}
    <form method="POST" action="{{ route('submissions.store') }}" enctype="multipart/form-data" class="p-6">
        @csrf
                ...
                @foreach($categories as $category)
                    <div class="relative">
                        <input type="radio" 
                               ...
                               value="{{ $category->id }}"
                               class="peer hidden"
                               {{ old('category_id', $selectedCategory?->id) == $category->id ? 'checked' : '' }}>
        ...
        <div class="mb-6">
            ...
            <div class="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center">
                ...
                <div id="file-drop-area" onclick="document.getElementById('attachment').click()" class="cursor-pointer">
                    ...
                    <p class="text-gray-600 mb-1">Klik untuk memilih file atau drag & drop</p>
            ...
            <div class="flex items-start space-x-3">
                ...
                <div class="text-sm text-blue-800">
                    ...
                    <ul class="list-disc list-inside space-y-1">
                        <li>Biaya submit konten: <strong>Rp 5.000</strong> per postingan</li>
                        <li>Konten akan direview dalam <strong>1x24 jam</strong> setelah pembayaran</li>
                        <li>Anda akan mendapat notifikasi tentang status approval</li>
                        <li>Pastikan konten sesuai dengan kategori yang dipilih</li>
                        <li>Konten yang disetujui akan dipublikasikan otomatis</li>
                    </ul>
                </div>
            </div>
        </div>
